...
SUBMISSION_JSON="$(delta_notarization_submission_path "$NOTARY_OUTPUT_DIR" dmg "$VERSION" "$BUILD")"
LOG_JSON="$(delta_notarization_log_path "$NOTARY_OUTPUT_DIR" dmg "$VERSION" "$BUILD")"
