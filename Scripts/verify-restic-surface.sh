...
assert_options_contains "rest\\.connections"
assert_options_contains "b2\\.connections"
assert_options_contains "azure\\.connections"
assert_options_contains "gs\\.connections"
assert_options_contains "swift\\.connections"
assert_options_contains "rclone\\.program"
assert_options_contains "rclone\\.connections"
assert_options_contains "s3\\.region"
assert_options_contains "s3\\.connections"
