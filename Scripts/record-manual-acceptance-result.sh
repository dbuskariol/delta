...
Examples:
  Scripts/record-manual-acceptance-result.sh dist/manual-acceptance/latest.md settings_surface Passed "Manual evidence: opened Settings in /Applications/Delta.app <version> (<build>), confirmed native General/Permissions/Defaults/Updates/Advanced cards, aligned controls, access actions, update controls, defaults, and diagnostics."
