...
SUBMISSION_JSON="$(delta_notarization_submission_path "$OUTPUT_DIR" app "$SHORT_VERSION" "$BUILD_VERSION")"
LOG_JSON="$(delta_notarization_log_path "$OUTPUT_DIR" app "$SHORT_VERSION" "$BUILD_VERSION")"
