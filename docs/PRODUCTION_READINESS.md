...
| Menu bar | Confirm the menu bar icon changes for ready, running, and attention states; Back Up Now, Run Due Backups, Pause, Stop, Activity, Updates, last backup status, and status transitions work without the menu closing unexpectedly on completion. |
